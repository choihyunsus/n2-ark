# Examples — Domain-Specific Rule Templates

Domain experts can customize these `.n2` files for their specific industry.
Copy any file into your `rules/` directory to activate it.
